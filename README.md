...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fortran-language-server-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14608&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fortran-language-server-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fortran-language-server` can be installed with:

```
conda install fortran-language-server
```

It is possible to list all of the versions of `fortran-language-server` available on your platform with:
